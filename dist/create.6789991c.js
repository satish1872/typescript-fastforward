...
form.addEventListener("submit", async (e)=>{
    ...
    const res = await (0, _pizza.Pizzas).save(newPizza);
    if (!res.ok) console.log("not able to save new pizza");
...
parcelHelpers.export(exports, "Pizzas", ()=>Pizzas);
var _dataResource = require("../services/DataResource");
const Pizzas = new (0, _dataResource.DataResource)("http://localhost:3000/pizzas");
Pizzas.save({
    title: "Mario Special2",
    description: "An extra cheesy pizza2 on a thin and crispy base, loaded with olives and mushrooms.",
    toppings: [
        "mushrooms",
        "olives",
        "onions"
...
},{}]},["wXxF1","4WE0n"], "4WE0n", "parcelRequire40cf")
